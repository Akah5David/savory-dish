import {
  useFetchClient
} from "./chunk-TY4OZUVS.js";
import {
  selectAdminPermissions
} from "./chunk-QUX4XYVB.js";
import {
  useEnterprise
...
var ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(AdminSeatInfoCE, async () => (await import("./AdminSeatInfo-MPIDBGT7.js")).AdminSeatInfoEE);
  const isAiEnabled = ((_a = window.strapi.ai) == null ? void 0 : _a.enabled) !== false;
  const AIUsageData = useEnterprise(AIUageDataCE, async () => (await import("./AIUsage-5KR5B5MB.js")).AIUsage, {
    enabled: isAiEnabled
  });
...
//# sourceMappingURL=ApplicationInfoPage-SDXROPUV.js.map
