import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-RNFOMM46.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-YDQPAPQM.js";
import {
  LimitsModal
} from "./chunk-4STZVJXL.js";
import {
...
} from "./chunk-6ZLCDLDK.js";
import {
  useTypedSelector
} from "./chunk-7CUGFTA6.js";
import {
  ...
  useGetLocalesQuery
} from "./chunk-RYDYFWK3.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-BLNSTUJL.js";
import {
  index
} from "./chunk-HPECRBES.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-IDJQLPPL.js";
import {
  useConfig
} from "./chunk-SJRFDKZ7.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-VDLFTLVW.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-5V57HTKQ.js";
import {
  buildValidParams,
...
import {
  renderAdmin
} from "./chunk-CTJEZX42.js";
import {
  useLicenseLimits
} from "./chunk-TSLJUNC3.js";
import {
  Table,
  useTable
} from "./chunk-3BE3O3AO.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-NP5NZT7L.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-R3JQFRGO.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-DFBSZRUV.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-UWB3DR5X.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-DKW5NEI6.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-57SRGTCK.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-MD4XHHDL.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-BVG2KOIY.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-IXP6V6M2.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-NNMIS4BG.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-OGNFDOLV.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-BFG6IMMY.js");
          return {
...
//# sourceMappingURL=chunk-RGCCJYO5.js.map
